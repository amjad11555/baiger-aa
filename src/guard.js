...
const BANNED_PHRASES = [
  ...
  {
    re: /(منعمل|بنعمل|نعمل|نعملك|نعمللك|منجهز|بنجهز|نرتب|منرتب|نحجز|بنحجز|عندنا|بنقدم|منقدم)\s+(جلسة|جلسات)\s+تصوير|نصوّر\s+عندك|نصور\s+عندك|نبعت(لك)?\s+مصوّر|مصوّر\s+(يجي|بيجي|يمر)/,
